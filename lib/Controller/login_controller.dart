...
class LoginController extends GetxController {
  ...
  final String loginApiUrl = 'http://192.168.1.114:3002/api/login';
  final String signUpApiUrl = 'http://192.168.1.114:3002/api/signup';
  final String userProfileUrl =
      'http://192.168.1.114:3002/api/users/userProfile';
...
Future<void> signInWithGoogle() async {
  try {
    ...
    final response = await http.post(
        Uri.parse('http://192.168.1.114:3002/api/auth/googleUserData'),
