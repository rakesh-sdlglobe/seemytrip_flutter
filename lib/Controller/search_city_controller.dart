...
class SearchCityController extends GetxController {
  ...
  Future<void> _fetchCities() async {
    ...
    try {
      final response = await dio.post(
        'http://192.168.247.190:3002/api/hotels/getHotelCities',
        options: Options(
  ...
  Future<void> fetchHotelDetails({
    ...
    try {
      ...
      final response = await dio.post(
        'http://192.168.247.190:3002/api/hotels/getHotelsList',
        options: Options(
          headers: {'Content-Type': 'application/json'},
  ...
  Future<void> fetchHotelDetailsWithPrice({
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://192.168.247.190:3002/api/hotels/getHoteldetails'),
        headers: {
  ...
  Future<List<String>> fetchHotelImages(String hotelProviderSearchId) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://192.168.247.190:3002/api/hotels/getHotelImages'),
        headers: {'Content-Type': 'application/json'},
