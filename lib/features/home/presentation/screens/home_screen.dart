                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  ...
                                  Get.to(() => ComingSoonScreen(
                                      moduleName: 'Home Stays'));
                                },
                                child: Column(
                                  children: [
                                    SizedBox(height: 70),
                                    Image.asset(homeStays,
                                        height: 55, width: 55),
                                    SizedBox(height: 8),
                                    CommonTextWidget.PoppinsMedium(
                                      text: 'homeStays'.tr,
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        border: Border.all(
                                          color:
                                              AppColors.redCA0.withOpacity(0.2),
                                          width: 1,
                                        ),
                                      ),
                        ...
                        InkWell(
                          onTap: () {
                            Get.to(() =>
                                ComingSoonScreen(moduleName: 'Welcome Offers'));
                          },
                          child: Padding(
                            padding: EdgeInsets.symmetric(horizontal: 24),
                            child: Column(
                        ...
                        InkWell(
                          onTap: () {
                            Get.to(() => ComingSoonScreen(
                                moduleName: 'Tourism Flagship Stores'));
                          },
                          child: Padding(
                            padding: EdgeInsets.symmetric(horizontal: 24),
                            child: Column(
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color:
                                            AppColors.grey656.withOpacity(0.25),
                                        blurRadius: 5,
                                      ),
                                    ],
                                  ),
