...
class BusPassengerDetailsScreen extends StatefulWidget {
  ...
  const BusPassengerDetailsScreen({
    required this.fromCity, required this.toCity, required this.busName, required this.travelDate, required this.departureTime, required this.arrivalTime, required this.fare, required this.selectedSeats, required this.boardingPoint, required this.droppingPoint, super.key,
  });
...
class _BusPassengerDetailsScreenState extends State<BusPassengerDetailsScreen> {
  ...
  void initState() {
    ...
    _ageControllers =
        List.generate(passengerCount, (_) => TextEditingController());
    _genderSelections =
        List.generate(passengerCount, (_) => <bool>[true, false]); // Default to Male
  ...
  void dispose() {
    ...
    for (TextEditingController controller in _nameControllers) {
      controller.dispose();
    }
    for (TextEditingController controller in _ageControllers) {
      controller.dispose();
    }
    super.dispose();
  }
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          ListView.separated(
            ...
            itemBuilder: (BuildContext context, int index) => _buildPassengerForm(index: index),
      ...
      children: <Widget>[
        Align(
          ...
          child: Chip(
            ...
            backgroundColor: _AppStyles.success.withValues(alpha: 0.1),
        ...
        children: <Widget>[
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              elevation: 5,
              shadowColor: _AppStyles.primary.withValues(alpha: 0.5),
            ),
            child: Text(
              'Proceed',
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: selected ? _AppStyles.primary.withValues(alpha: 0.1) : _AppStyles.background,
