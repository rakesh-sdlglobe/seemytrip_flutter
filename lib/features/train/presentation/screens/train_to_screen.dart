...
import 'package:seemytrip/features/train/presentation/controllers/traintoSearchController.dart';

class TrainToScreen extends StatefulWidget {
  TrainToScreen({Key? key}) : super(key: key);

  @override
  _TrainToScreenState createState() => _TrainToScreenState();
}

class _TrainToScreenState extends State<TrainToScreen> {
