...
class TrainAndBusModifySearchScreen extends StatefulWidget {
  ...
  @override
  State<TrainAndBusModifySearchScreen> createState() =>
      _TrainAndBusModifySearchScreenState();
}

class _TrainAndBusModifySearchScreenState
    extends State<TrainAndBusModifySearchScreen> {
  int selectedIndex = 0;
