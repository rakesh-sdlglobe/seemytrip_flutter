  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        //           children: [
        //             Padding(
        //               padding: EdgeInsets.only(top: 8, left: 08, bottom: 8),
        //               child: Column(
        //                 crossAxisAlignment: CrossAxisAlignment.start,
        //                 children: [
        ...
        //                       left: 10, top: 14, right: 0, bottom: 35),
        //                   child: CommonTextWidget.PoppinsMedium(
        ...
        //                   child: CommonTextWidget.PoppinsMedium(
        //                     text: "ADULT : ₹ 3,350 + ₹ 300 + Fare difference",
        //                     color: black2E2,
        //                     fontSize: 11.5,
        //                     textAlign: TextAlign.end,
        //                   ),
        ...
        //                 Padding(
        //                   padding:
        //                       EdgeInsets.only(left: 10, right: 0, bottom: 35),
        //                   child: CommonTextWidget.PoppinsMedium(
        //                     text: "ADULT : ₹ 2,535 + ₹ 300 + Fare difference",
        //                     color: black2E2,
        //                     fontSize: 11.5,
        //                     textAlign: TextAlign.end,
        //                   ),
